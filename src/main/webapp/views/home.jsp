...
<body>
	...
	<p>
		...
		<a href="<c:url value="/welcome" />"> List of Products </a><br /><br />
		<a href="<c:url value="/personList" />"> List of Person </a><br /><br />
		<a href="<c:url value="/orderList" />"> List of Orders </a><br /><br />
